import { Badge, Button, Container, Stepper, TextInput, useMantineTheme } from '@mantine/core';
...
const element = {
	...
	apply: {
		...
		inputs: [
			{
				id: 'img_mc',
				name: 'A link to a picture of buildings you have built in Minecraft',
				placeholder: 'https://...',
			},
				...
				{!element.apply.enabled ? (
					...
					<div>
						<Stepper active={user?.name ? (element.userStatus === 'Builder' ? 2 : 1) : 0}>
							...
							<Stepper.Step label="Start Building" description="Build the Earth!">
								{/* TODO: Tell them that they got accepted*/}
								<p>
									You got accepted into <b>{element.name}</b>. You got granted a new Role:
								</p>
								<Badge color="green">Builder</Badge>
							</Stepper.Step>
						</Stepper>
					</div>
				)}
