...
import fetcher, { globalFetcher } from '../utils/Fetcher';
...
const Credits = ({ contributors }: any) => {
	return (
			...
			<Container w="80vw" style={{ listStyleType: 'none' }}>
				...
				<p>
					...
					<Anchor component={Link} href={'https://github.com/BuildTheEarth/website-node-backend'}>
						https://github.com/BuildTheEarth/website-node-backend
					</Anchor>{' '}
					and{' '}
					<Anchor component={Link} href={'https://github.com/BuildTheEarth/website-frontend'}>
						https://github.com/BuildTheEarth/website-frontend
					</Anchor>
